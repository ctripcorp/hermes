 ...
 *
 */
public class AckMessageCommandV5 extends AbstractCommand {
	...
	public AckMessageCommandV5() {
		super(CommandType.MESSAGE_ACK_V5, 5);
	}

	public AckMessageCommandV5(String topic, int partition, String group, long timeout) {
		super(CommandType.MESSAGE_ACK_V5, 5);
		m_topic = topic;
