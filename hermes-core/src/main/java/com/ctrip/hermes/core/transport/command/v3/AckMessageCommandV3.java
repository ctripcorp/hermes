 ...
 *
 */
public class AckMessageCommandV3 extends AbstractCommand {
	...
	public AckMessageCommandV3() {
		super(CommandType.MESSAGE_ACK_V3, 3);
	}

	public AckMessageCommandV3(String topic, int partition, String group) {
		super(CommandType.MESSAGE_ACK_V3, 3);
		m_topic = topic;
