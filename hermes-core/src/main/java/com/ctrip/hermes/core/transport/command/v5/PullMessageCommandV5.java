 ...
 *
 */
public class PullMessageCommandV5 extends AbstractPullMessageCommand {
	...
	public PullMessageCommandV5() {
		this(null, -1, null, null, 0, -1L, null);
	}

	public PullMessageCommandV5(String topic, int partition, String groupId, Offset offset, int size, long expireTime,
	      String filter) {
		super(CommandType.MESSAGE_PULL_V5, 5, topic, partition, expireTime);
		m_groupId = groupId;
		m_offset = offset;
		m_size = size;
		m_filter = filter;
	...
	public String toString() {
		return "PullMessageCommandV5 [m_groupId=" + m_groupId + ", m_offset=" + m_offset + ", m_size=" + m_size
